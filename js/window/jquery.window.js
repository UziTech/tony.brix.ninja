      ...
      return this.each(function(){
        ...
        */
        ...
        data.settings = $.extend({
          shortcutID: "",
          titleIcon: "js/window/images/cmd_icon.png", ///16px X 16px
          title: "cmd",
          initHeight: function(){return ($(window).height() - 89);},
          initWidth: function(){return ($(window).width() - 41);},
          initTop: 15,
          initLeft: 15,
          minHeight: 1,///must be 1 or greater because of a chrome bug
          maxHeight: 0,///0 = window max
          minWidth: 1,///must be 1 or greater because of a chrome bug
          maxWidth: 0,///0 = window max
          onBeforeClose: $.noop,
          onAfterClose: $.noop,
        ...
        data.restore = {top: data.settings.initTop, left: data.settings.initLeft, height: data.settings.initHeight, width: data.settings.initWidth, isInWindow: function (){
